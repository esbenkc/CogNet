...
**Authors:** [Esben Kran](https://kran.ai) & [Jonathan Hvithamar Rystrøm](https://linkedin.com/in/jonathan-rystroem) <br/>
...
The anonymized data contains a message per row between two of the 27 users (28 minus 1 dropout). The weight of a message is $1$ for a direct message, while a group message is weighted as $\dfrac{1}{n-1}$ where $n$ is the amount of users in the group (the sender inclusive).
...
Released under [MIT](/LICENSE) by [\@rysias](https://github.com/rysias) and [\@esbenkc](https://github.com/esbenkc).
